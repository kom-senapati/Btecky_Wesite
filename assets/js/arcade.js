...
const info = [
  {
    title: "<b>Power Up Your Cloud Skills with the Google Cloud Arcade!</b>",
    ...
    desp2: "Here's why the Google Cloud Arcade is your ultimate playground for cloud learning:",
    desp3: "<b>Play Your Way to Expertise:</b> Choose from a variety of themed games, each brimming with exciting labs tailored to different skill levels. Whether you're a cloud novice or a seasoned pro, the Arcade caters to your learning jounery.<br><br><b>Earn Bragging Rights:</b> Compete with fellow cloud enthusiasts and conquer leaderboards. Rack up points, collect badges that validate your prowess, and showcase your cloud achievements to the world!ourney.<br><br><b>Unlock Valuable Rewards:</b> As you progress through the Arcade, you'll accumulate points that can be redeemed for enticing prizes. The spoils of victory await the most dedicated cloud champions!",
  },

    {
    title: "<b>The Google Cloud Arcade is your one-stop shop for:</b>",
    ...
    {
    title: "<b>Ready to embark on your cloud gaming odyssey?</b>",
