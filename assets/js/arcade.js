...
const info = [
  {
    ...
    desp3: "Play Your Way to Expertise: Choose from a variety of themed games, each brimming with exciting labs tailored to different skill levels. Whether you're a cloud novice or a seasoned pro, the Arcade caters to your learning jounery.<br>Earn Bragging Rights: Compete with fellow cloud enthusiasts and conquer leaderboards. Rack up points, collect badges that validate your prowess, and showcase your cloud achievements to the world!ourney.<br>Unlock Valuable Rewards: As you progress through the Arcade, you'll accumulate points that can be redeemed for enticing prizes. The spoils of victory await the most dedicated cloud champions!",
  },
